...
const Content = () => {
    ...
    const fetchMovies = async () => {
      const options = {
        ...
        headers: {
          ...
          Authorization:
            "Bearer eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiIzNjQ0Y2JiMzI5MDgyZTk1OTAzZDk2ZjEyODNlM2I2OSIsInN1YiI6IjY2MmVjZjllYTgwNjczMDEyYmU4Zjk1ZSIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.nYL5Y57gkbQgzUIyklXYX8Hft8YIQH4XvX85IHGgCXk",
        },
      };
      try {
  ...
  const handlePrevSlide = () => {
    setCurrentSlide(
      currentSlide === 0 ? upcomingMovies.length - 1 : currentSlide - 1
    );
  };

  const handleNextSlide = () => {
    setCurrentSlide(
      currentSlide === upcomingMovies.length - 1 ? 0 : currentSlide + 1
    );
  };
    ...
    <>
      <div className="container-fluid bg-dark text-light py-4">
        ...
        <div className="slider-container">
          ...
          >
            <i className="bi bi-chevron-left z-index-1"></i>
          </button>
